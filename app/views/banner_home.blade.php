				...
				<div role="tabpanel">
					...
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane fade in active" id="home">
										...
										if($open = opendir($dir)){
											...
											while(($file = readdir($open)) != FALSE){
												if($file != "." && $file !='..'){
													...
													<span class="sys_delete_banner"><a href="sys_destroy_banner?file='.$file.'">Xóa</a></span>
													<a>
							...
							<div class="row">
								<form action="{{asset('sys_store_banner_home')}}" method="POST">
									@foreach($bans as $keys => $vals)
									<div class="col-lg-6">
										<div class="form-group div_in_banner">
											<label>URL hình</label>
											<input type="text" class="form-control" id="input_url" name="link" value="{{$vals->link}}">
										</div>
						...
						<div role="tabpanel" class="tab-pane fade" id="profile">
							<form action="{{asset('sys_upload_banner')}}" method="POST" enctype="multipart/form-data">
								<div class="col-lg-6">
									<div class="form-group div_in_banner">
